...
% 20 agentes 500 iteracoes
run26 = [1.876236      634.6895    -0.4523468     0.0411044  -0.001465314     0.8295323    -0.1282967    0.01065004     0.3232179];
run27 = [1.507157      752.0264     -0.485379    0.08192876    0.07431759     0.8844973      1.726676     0.2691478  -0.001208785];
run28 = [1.042393           500    -0.3946309     0.1063585    0.04007936     0.5151707   -0.07416003   -0.08430115     0.2059414];
run29 = [448.8698       795.748    -0.6608092     0.1717899    0.01558577      1.203766    0.08069659   -0.03159781     0.3920185];
run30 = [8.598229      782.9464    -0.4996256   -0.02906976    0.01381888     0.6334358    0.05631815   -0.01688166     0.3891228];

% 30 agentes 500 iteracoes
run31 = [4.760886      624.2024    -0.7232387     0.3108377    0.02013852     0.7717093     -1.039579    0.06562902     0.4866676];
run32 = [5.257435      523.3244    -0.8974427     0.2873169     0.0183113     0.7951695    -0.5095651     0.1082311     0.5954031];
run33 = [2.231627      687.2103     -1.483041     0.8859536   -0.03343443             2    -0.5071737     0.1288203     0.4981473];
run34 = [11.15939      968.4819    -0.7536114     0.2355404    0.01932643      1.676288     0.2821333    0.08912635     0.5053807];
run35 = [53.53755      501.6126    -0.8907209      0.186451   -0.05811583     0.6229828     -1.117454    0.02660842     0.6897471];

% 40 agentes 500 iteracoes
run36 = [42.95258      996.3403    -0.6475327      0.247547    0.01548995        1.3475    -0.6814627     0.0879156     0.4940759];
run37 = [13.549691           1000     -1.4558227     0.68912267   0.0054703294              2    -0.29276367     0.11945735     0.73681887];
run38 = [1.36031      557.6601    -0.7738702     0.2934647    0.01693123      1.371488   -0.07159048    0.06144152     0.4347482];
run39 = [2.987759      524.4037     -0.271217   0.008024888    0.02099139     0.5567917    0.00733175    0.01501199    0.01772748];
run40 = [2.12905      654.8548    -0.9358377     0.3342473  -0.001208552      1.213813    -0.3981114  -0.004366744     0.5282429];

% 50 agentes 500 iteracoes
run41 = [39.5176          1000    -0.8138396     0.3179858    0.01137553        1.4737    -0.3687064   -0.06758995     0.3393941];
run42 = [6.80829      842.6467    -0.5329962     0.1789818   0.005394658      1.191961    -0.4230964    0.05805832     0.3155955];
...
logFilename = 'Outputs_Final/Resultados.txt';
diary(logFilename); 

display('-------------------------------------');
display('Ganhos usados:');
display(['Gamma: ', num2str(ganho(1))]);
display(['Kappa: ', num2str(ganho(2))]);
display(['Theta1: ', num2str(ganho(3))]);
display(['Theta2: ', num2str(ganho(4))]);
display(['Theta3: ', num2str(ganho(5))]);
display(['Theta4: ', num2str(ganho(6))]);
display(['Theta5: ', num2str(ganho(7))]);
display(['ThetaA: ', num2str(ganho(8))]);
display(['ThetaS: ', num2str(ganho(9))]);
display('Resultados simulacao:');
